...
const DefaultDebugConfig: FDebugConfig = {
  ...
  BattleIntroCameraStartDistanceCm: 420,
  BattleIntroCameraStartHeightCm: 130,
  BattleIntroCameraEndDistanceCm: 190,
  BattleIntroCameraEndHeightCm: -10,
  BattleIntroDurationSec: 1,
  BattleIntroFovDeg: 76,
  BattleFollowFocusOffsetRightCm: 145,
  BattleFollowFocusOffsetUpCm: -25,
  BattleDropStartHeightCm: 30,
  BattleDropDurationSec: 0.2,
  BattlePromptDurationSec: 0.5,
  BattleFollowShoulderOffsetCm: 15,
  PlayerAimFovDeg: 80,
  PlayerAimDistanceCm: 30,
  PlayerAimShoulderOffsetCm: 145,
  PlayerAimSocketUpCm: 55,
  PlayerAimLookForwardDistanceCm: 400,
  PlayerAimFocusOffsetRightCm: -205,
  PlayerAimFocusOffsetUpCm: 0,
  SkillPreviewFovDeg: 75,
  SkillPreviewDistanceCm: 170,
  SkillPreviewShoulderOffsetCm: 90,
  SkillPreviewSocketUpCm: 80,
  SkillPreviewLookForwardDistanceCm: 330,
  SkillPreviewFocusOffsetRightCm: 20,
  SkillPreviewFocusOffsetUpCm: 10,
  ItemPreviewFovDeg: 40,
  ItemPreviewDistanceCm: 290,
  ItemPreviewLateralOffsetCm: 45,
  ItemPreviewSocketUpCm: 30,
  ItemPreviewLookAtHeightCm: 165,
  ItemPreviewFocusOffsetRightCm: -60,
  ItemPreviewFocusOffsetUpCm: -145,
  TargetSelectCloseupDistanceCm: 340,
  TargetSelectCloseupHeightCm: 80,
  TargetSelectLookAtHeightCm: 70,
  TargetSelectLateralOffsetCm: -200,
  TargetSelectYawDeg: 165,
  TargetSelectFovDeg: 35,
